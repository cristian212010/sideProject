...
const enviarCorreoUsuarioRechazado= async (data) =>{
    try {
    
    console.log(data.mailerData.email);
    ...
    <body>
        ...
        <div class="padre" style=" margin: 0 auto; padding: 20px; border: 1px solid #ccc;">
            ...
            <div class="texto">
                ...
                <p style="color: #E4E4DB; text-align: center;">Hola ${data.mailerData.nombre_candidato}</p>
                <p style="color: #E4E4DB; text-align: center;">Se te informa que tus Datos para la creacion del candidato fueron Rechazados</p>
                <p style="color: #E4E4DB; text-align: center;">Te invitamos a que actualizes tu informacion para poder darte la aprovacion</p>
...
export default enviarCorreoUsuarioRechazado